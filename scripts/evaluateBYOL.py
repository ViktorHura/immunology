...
from modelBYOL import SiameseNetworkBYOL
...
def main():
    ...
    model = SiameseNetworkBYOL(test_data.tensor_size).to(device)
    model.load_state_dict(torch.load('../output/byolModel/'+model_name))
    model.eval()
